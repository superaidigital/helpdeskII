...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 24, 2025 at 05:42 PM
...
CREATE TABLE `issues` (
  ...
  `ai_interaction_id` int(11) DEFAULT NULL,
...
INSERT INTO `issues` (`id`, `user_id`, `reporter_name`, `reporter_contact`, `reporter_position`, `reporter_department`, `division`, `category`, `title`, `description`, `urgency`, `status`, `assigned_to`, `created_at`, `updated_at`, `completed_at`, `satisfaction_rating`, `signature_image`, `ai_interaction_id`, `device_id`) VALUES
...
(6, NULL, 'นางธัญชนก ธนปุญญ', '0653241939', 'ผู้อำนวยกองยุทธศาสตร์และงบประมาณ', 'กองยุทธศาสตร์และงบประมาณ', NULL, 'ระบบเครือข่าย', 'เชื่อมต่อ Wi-Fi ไม่ได้', 'ชื่อมต่อ Wi-Fi บน Windows 11 ไม่ได้', 'ด่วนมาก', 'done', 100, '2025-09-15 02:55:17', '2025-09-15 03:11:12', '2025-09-15 03:10:47', 5, 'uploads/signatures/sig_6_68c783d0178e0.png', NULL, NULL),
(7, NULL, 'ตาร์', '0458146676', '', '', NULL, 'ฮาร์ดแวร์', 'แชร์ปรินเตอร์', 'แชร์ปรินเตอร์จาก ให้ปริ้นจากเครื่องน้องแป้ง ไปเครื่องพี่หนุ่ย', 'ปกติ', 'done', 100, '2025-09-15 08:53:04', '2025-09-16 02:34:27', '2025-09-15 16:47:26', 5, 'uploads/signatures/sig_7_68c8ccb3d9b8b.png', NULL, NULL),
(8, NULL, 'พี่หมู', '0652192565', '', '', NULL, 'ซอฟต์แวร์', 'ให้คำปรึกษาด้านการแทรกเลขหน้า Microsoft Word', 'แทรกเลขหน้า', 'สามารถรอได้', 'done', 100, '2025-09-16 02:23:41', '2025-09-16 02:25:55', '2025-09-16 02:25:05', 5, 'uploads/signatures/sig_8_68c8cab30c915.png', NULL, NULL),
...
(10, NULL, 'พี่โตโต้', '0991755809', '', '', NULL, 'ซอฟต์แวร์', 'ไม่มีฟอนต์ Th sarabun it9', 'ไม่สามารถใช้งานฟอนต์ดังกล่าวได้', 'ปกติ', 'done', 102, '2025-09-17 08:57:35', '2025-09-17 09:03:15', '2025-09-17 09:03:15', NULL, NULL, NULL, NULL),
(11, NULL, 'นางสาวจิตรราภา  พิญญาณ', '0644496952', '', '', NULL, 'ฮาร์ดแวร์', 'ติดตั้งเครื่องสแกนเนอร์ พร้อมติดตั้งไดร์ฟเวอร์', 'ติดตั้งเครื่องสแกนเนอร์ เพื่อสแกนเอกสารราคากลาง', 'ด่วนมาก', 'done', 102, '2025-09-18 06:49:25', '2025-09-18 06:53:34', '2025-09-18 06:53:34', NULL, NULL, NULL, NULL),
(12, NULL, 'นางสาวจิตราภา  พิณญาณ', '0644496952', 'เจ้าพนักงานธุรการปฎิบัติงาน', 'สำนักช่าง', 'ออกแบบ', 'ฮาร์ดแวร์', 'ติดตั้งเครื่องสแกนเนอร์', 'ช่วยติดตั้งเครื่องสแกนเนอร์ เพื่อสแกนเอกสาร', 'ด่วนมาก', 'done', 102, '2025-09-18 06:58:41', '2025-09-18 07:01:02', '2025-09-18 07:01:02', NULL, NULL, NULL, NULL),
(13, NULL, 'นางสาวจิตราภา  พิญญาณ', '0644496952', '', '', NULL, 'ฮาร์ดแวร์', 'ติดตั้งเครื่องสแกนเนอร์', 'ช่วยติดตั้งเครื่องสแกนเนอร์ เพื่อสแกนเอกสาร', 'ด่วนมาก', 'done', 102, '2025-09-18 07:05:25', '2025-09-18 07:07:33', '2025-09-18 07:07:33', NULL, NULL, NULL, NULL);
...
--
-- Table structure for table `issue_devices`
--

CREATE TABLE `issue_devices` (
  `id` int(11) NOT NULL,
  `issue_id` int(11) NOT NULL,
  `ownership_type` enum('office','personal') NOT NULL,
  `device_category` varchar(100) NOT NULL,
  `asset_code` varchar(100) DEFAULT NULL,
  `brand` varchar(100) DEFAULT NULL,
  `specs_details` text DEFAULT NULL,
...
(5, 13, 'ฮาร์ดแวร์', 'ติดตั้งเครื่องสแกนเนอร์', 'จากข้อมูลที่ได้รับ ปัญหาคือการติดตั้งเครื่องสแกนเนอร์ เพื่อให้สามารถสแกนเอกสารได้ ผมขอแนะนำขั้นตอนการแก้ไขเบื้องต้นดังนี้:\r\n\r\n**ขั้นตอนที่ 1: ตรวจสอบข้อมูลพื้นฐาน**\r\n\r\n1.  **ประเภทของสแกนเนอร์:** ระบุประเภทของสแกนเนอร์ที่ต้องการติดตั้ง (เช่น Flatbed, ADF, Sheetfed, Network Scanner) เพื่อให้แน่ใจว่ามีไดรเวอร์และวิธีการติดตั้งที่ถูกต้อง\r\n2.  **ระบบปฏิบัติการ:** ตรวจสอบระบบปฏิบัติการของเครื่องคอมพิวเตอร์ที่จะใช้งาน (Windows, macOS, Linux) เพื่อเลือกไดรเวอร์ที่เหมาะสม\r\n3.  **การเชื่อมต่อ:** ตรวจสอบวิธีการเชื่อมต่อของสแกนเนอร์ (USB, Network) เพื่อเตรียมสายเคเบิลหรือการตั้งค่าเครือข่ายที่จำเป็น\r\n4.  **อุปกรณ์และสายเคเบิล:** ตรวจสอบให้แน่ใจว่ามีสาย USB (ถ้าจำเป็น), สายไฟ, และคู่มือการใช้งานของสแกนเนอร์ครบถ้วน\r\n\r\n**ขั้นตอนที่ 2: ติดตั้งไดรเวอร์**\r\n\r\n1.  **ดาวน์โหลดไดรเวอร์:** เข้าไปที่เว็บไซต์ของผู้ผลิตสแกนเนอร์ (เช่น HP, Epson, Canon) และดาวน์โหลดไดรเวอร์ล่าสุดสำหรับระบบปฏิบัติการที่ใช้งาน\r\n2.  **ติดตั้งไดรเวอร์:** ทำการติดตั้งไดรเวอร์ที่ดาวน์โหลดมา โดยทำตามขั้นตอนที่ปรากฏบนหน้าจอ (ส่วนใหญ่มักจะเป็นการคลิก \"Next\" หรือ \"ยอมรับ\")\r\n    *   **ข้อควรระวัง:** ในระหว่างการติดตั้ง ให้เลือกตัวเลือกที่เหมาะสม เช่น \"Custom Install\" เพื่อให้สามารถเลือกส่วนประกอบที่ต้องการติดตั้งได้ (โดยทั่วไปแนะนำให้ติดตั้งทุกส่วนประกอบที่เกี่ยวข้องกับการสแกน)\r\n3.  **Restart คอมพิวเตอร์:** หลังจากติดตั้งไดรเวอร์เสร็จสิ้น ให้ทำการ Restart คอมพิวเตอร์\r\n\r\n**ขั้นตอนที่ 3: เชื่อมต่อสแกนเนอร์**\r\n\r\n1.  **เชื่อมต่อสแกนเนอร์:** เชื่อมต่อสแกนเนอร์เข้ากับคอมพิวเตอร์โดยใช้สาย USB (ถ้าเป็น USB Scanner) หรือเชื่อมต่อเข้ากับเครือข่าย (ถ้าเป็น Network Scanner)\r\n2.  **เปิดสแกนเนอร์:** เปิดสแกนเนอร์\r\n\r\n**ขั้นตอนที่ 4: ตรวจสอบการทำงาน**\r\n\r\n1.  **Windows:** ไปที่ \"Control Panel\" -> \"Devices and Printers\" (หรือ \"Hardware and Sound\" -> \"Devices and Printers\") และตรวจสอบว่าสแกนเนอร์ปรากฏอยู่ในรายการหรือไม่ หากปรากฏ ให้คลิกขวาที่สแกนเนอร์ และเลือก \"Scan\" หรือ \"Start Scan\" เพื่อทดสอบการสแกน\r\n2.  **macOS:** ไปที่ \"System Preferences\" -> \"Printers & Scanners\" และตรวจสอบว่าสแกนเนอร์ปรากฏอยู่ในรายการหรือไม่ หากปรากฏ ให้เลือกสแกนเนอร์ และคลิกที่ปุ่ม \"Open Scanner...\" เพื่อทดสอบการสแกน\r\n3.  **โปรแกรมสแกน:** เปิดโปรแกรมสแกนที่ติดตั้งมาพร้อมกับไดรเวอร์ (หรือโปรแกรมสแกนที่ใช้งานอยู่) และทำการสแกนเอกสารเพื่อตรวจสอบว่าสแกนเนอร์ทำงานได้ถูกต้องหรือไม่\r\n\r\n**ขั้นตอนที่ 5: แก้ไขปัญหาเบื้องต้น (ถ้าจำเป็น)**\r\n\r\n*   **สแกนเนอร์ไม่ปรากฏในรายการ:**\r\n    *   ตรวจสอบการเชื่อมต่อของสาย USB หรือการตั้งค่าเครือข่าย\r\n    *   ลองถอดและเสียบสาย USB ใหม่\r\n    *   ลอง Restart คอมพิวเตอร์และสแกนเนอร์\r\n    *   ตรวจสอบว่าไดรเวอร์ถูกติดตั้งอย่างถูกต้อง\r\n*   **ไม่สามารถสแกนได้:**\r\n    *   ตรวจสอบว่าเอกสารถูกวางบนสแกนเนอร์อย่างถูกต้อง\r\n    *   ตรวจสอบว่าสแกนเนอร์อยู่ในสถานะ \"Online\" หรือ \"Ready\"\r\n    *   ลองปรับการตั้งค่าการสแกน (ความละเอียด, ขนาดเอกสาร, ฯลฯ)\r\n    *   ตรวจสอบว่ามีข้อความแสดงข้อผิดพลาดปรากฏหรือไม่ และทำการแก้ไขตามคำแนะนำ\r\n*   **ภาพที่สแกนไม่ชัดเจน:**\r\n    *   ทำความสะอาดกระจกของสแกนเนอร์\r\n    *   ปรับความละเอียดของการสแกน\r\n    *   ตรวจสอบว่าเอกสารที่สแกนไม่ได้ยับหรือมีรอยเปื้อน\r\n\r\n**ขั้นตอนที่ 6: ติดต่อผู้เชี่ยวชาญ (ถ้าจำเป็น)**\r\n\r\nหากทำตามขั้นตอนข้างต้นแล้วยังไม่สามารถแก้ไขปัญหาได้ ให้ติดต่อผู้เชี่ยวชาญด้าน IT หรือผู้ผลิตสแกนเนอร์เพื่อขอความช่วยเหลือเพิ่มเติม\r\n\r\n**หมายเหตุ:** ขั้นตอนเหล่านี้เป็นเพียงแนวทางเบื้องต้น อาจมีการเปลี่ยนแปลงเล็กน้อยขึ้นอยู่กับประเภทและรุ่นของสแกนเนอร์', 100, '2025-09-23 18:16:30');
...
(100, 'ปฐวีกานต์ ศรีคราม', 'นักวิชาการคอมพิวเตอร์ปฏิบัติการ', 'กองยุทธศาสตร์และงบประมาณ', 'ประชาสัมพันธ์', '0981051534', 'maxmumi37', 'itmax@sisaket.go.th', '$2y$10$DnoSEFkiEApZXAl0LcbQTOedEusKePVykzaQbm.Wg0.YddkHmSNYK', 'uploads/avatars/avatar_68c6de9a46f5c.png', 'it', '2025-09-14 08:43:56'),
...
(104, 'ปฐวีกานต์ ศรีคราม', 'นักวิชาการคอมพิวเตอร์', 'กองยุทธศาสตร์และงบประมาณ', 'ประชาสัมพันธ์', '0981051534', '', 'adminmax@sisaket.go.th', '$2y$10$AZWxqMWi6J2go9yEtp.8p.jboJujvy/dhgDRN2nwOWxoyEgQqD6IW', 'assets/images/user.png', 'admin', '2025-09-24 15:22:22');
...
--
-- Indexes for table `issue_devices`
--
ALTER TABLE `issue_devices`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `issue_devices`
--
ALTER TABLE `issue_devices`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
